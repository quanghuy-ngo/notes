...
In the log file on HPC we generated copy the command like: 
```
"ssh -N -L 8240:r25-n25:8240 axxxxxxxx@phoenix-login1.adelaide.edu.au"\
```
Open a terminal on local machine and run the above command (authentication step might required). After that in your browser access to the url given in the log file on phoenix. The url should similar to this: 
```
"http://127.0.0.1:xxxx/?token=703b02614d1866a4f722008af39c6b1b294505bxxxxxxxxxxx"
```
## Using Job Arrays
